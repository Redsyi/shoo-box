...
/// <summary>
/// class representing the sandal that the player flings out
/// </summary>
public class SandalProjectile : MonoBehaviour
{
    ...
    //reverse when it hits a collider
    ...
    //move towards target if not reversing, otherwise move towards player
