...
/// <summary>
/// class to manage a single stoplight in a city intersection. manages light color, and tells intersection if it was destroyed - intersection handles all other logic
/// </summary>
